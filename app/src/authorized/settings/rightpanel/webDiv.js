define(['react'], function (React) {
	return React.createClass({
		getInitialState : function() {
			...
			var dataSet = [
				['scsdfsdfsdfsdfsdfdfgfgdfgdfgdfgdfgdfgdfgdfgsdfsdfsdfrail.com','2015-05-18 07:44','2015-05-18 07:44',del],
				['dfdmail.com','2015-04-18 07:44','2015-01-18 07:44',del]
			];
			return {
				...
				$('#table1').dataTable(
					{
						...
						"columnDefs": [
							{ "sClass": 'col-md-5 col-xs-4', "targets": 0},
							{ "sClass": 'col-md-2 col-xs-2 text-align-center hidden-xs', "targets": [1]},
							{ "sClass": 'col-md-2 col-xs-2 text-align-center', "targets": [2]},
							{ "sClass": 'col-md-1 col-xs-2 text-align-center', "targets": [3]},
							...
							<ul className="nav nav-tabs tabbed-nav">
								<li role="presentation" className={this.state.firstTab}>
									<a onClick={this.handleClick.bind(this, 'showFirst')}>
										<h3 className="panel-title personal-info-title">WebDiv Files</h3>
									</a>
								</li>
							</ul>
						</div>
