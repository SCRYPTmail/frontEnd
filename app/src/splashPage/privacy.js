			...
			<section className="services grey-bg" id="section1">
				<div className="container">
					<div className="section-header">
						<h2 className="dark-text">Privacy Statement of SCRYPTmail</h2>
					...
					<div className="row sMailTextAlignLeft">
						...
						<ul>
							<li>
								Account activity involving sending or receiving email to/from third party server -
								Due to limitations of the SMTP protocol, we have access to the following email metadata: sender and recipient email addresses, the IP address incoming messages originated from, message subject, body and attachments and message sent and received times.
								<br/>
								<br/>
							</li>
